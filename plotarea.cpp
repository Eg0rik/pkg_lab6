...
// Устанавливаем возможность вращения
void PlotArea::SetRotatable(bool newRotatable)
{
    isRotatable = newRotatable;
}
// Пересчитываем оси на основе матрицы
...
// Адаптируем точки объектов к экранным координатам
...
// Отрисовываем метки на осях координат
void PlotArea::drawTicks(QPainter& p)
{
 ...
 // Отрисовываем стрелки на осях координат
...
// Проецируем фигуру на плоскость
...
//Устанавливаем точки фигуры для отображения
