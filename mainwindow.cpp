    ...
    , ui(new Ui::MainWindow)
{
    ...
    //трехмерная фигура  - Буква Е
    area -> SetFigurePoints(
    { Point(7, 1, 0), Point(7, 3, 0), Point(3, 3, 0),Point(3, 5, 0),Point(5, 5, 0),Point(5, 6, 0),Point(3, 6, 0), Point(3, 8, 0),
     Point(7, 8, 0), Point(7, 10, 0),  Point(1, 10, 0), Point(1, 1, 0), Point(7, 1, 0),
      Point(7, 1, 1), Point(7, 3, 1), Point(3, 3, 1),Point(3, 5, 1),Point(5, 5, 1),Point(5, 6, 1),Point(3, 6, 1), Point(3, 8, 1),
     Point(7, 8, 1), Point(7, 10, 1),  Point(1, 10, 1), Point(1, 1, 1), Point(7, 1, 1)});
}
...
// получаем текущую матрицу преобразования из area
...
//проекции фигуры на плоскости OXY, OXZ и OYZ.
